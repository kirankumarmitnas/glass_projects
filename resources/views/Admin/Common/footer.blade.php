...
<div class="col-md-6 col-5 text-start text-white"><a href="#" class="text-white text-decoration-none">Question Bank</a> © <span class="fw-bold"><?php echo date("Y");?></span>.</div>
